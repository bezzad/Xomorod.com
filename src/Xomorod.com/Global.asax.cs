...
namespace Xomorod.Com
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        protected void Application_Error(object sender, EventArgs e)
        {
            ...
            routeData.Values["culture"] = CultureHelper.GetCurrentCultureTwoLetter();
        ...
        {
            var result = "";
            var args = arg.ToLower().Split(new[] { ';', ',', '|' }, StringSplitOptions.RemoveEmptyEntries);
            ...
            foreach (var seq in args)
            {
                ...
                {
                    result += CultureHelper.GetCurrentCultureTwoLetter() + "_";
                }
                else
                {
                    result += base.GetVaryByCustomString(context, arg) + "_";
                }
            }
